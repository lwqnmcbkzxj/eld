...
router.get('/:user_id', async (req, res) => {
    ...
    try {
        ...
        u.user_trailer_number, u.co_driver_id, cd.user_first_name, cd.user_last_name, ct.company_terminal_id, ct.company_terminal_address,
        u.timezone_id, tz.timezone_name, u.user_notes, u.user_personal_conveyance_flag, u.user_eld_flag, u.user_yard_move_flag,
        u.user_manual_drive_flag
        ...
        left join company_terminal ct on u.company_terminal_id = ct.company_terminal_id
